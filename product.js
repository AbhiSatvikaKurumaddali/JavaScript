...
const products = [
                          ...
                          export function getProductById(id) {
                            console.log(products.find(obj=>obj.id==id));
                          }
                          ...
                          export function getProductsByCategory(category) {
                            console.log(products.filter(obj=>obj.category==category))
                          }
                          
                          export function searchProducts(query) {
                            console.log(products.find(obj=>obj.name.toLowerCase()==query.toLowerCase()))
                          }
                          ...
                          export function reduceStock(productId, quantity) {
                            let index=products.findIndex(obj=>obj.id=productId)
                            products[index].stock=products[productId].stock-quantity
                          }