...
const movieDescriptions = movies.map(movie => `${movie.title} (${movie.rating})`);
console.log("Movie Descriptions:", movieDescriptions);
// 3. reduce() to find average movie rating
...
console.log("Found Movie 'Joker':", jokerMovie);
// 5. findIndex() of "Avengers"
